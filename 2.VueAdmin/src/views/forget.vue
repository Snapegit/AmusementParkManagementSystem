<template>
	<div>
		<canvas id="canvas" style="background:url(http://clfile.zggen.cn/20231120/5c406dea56f94e7a8862ce254a053b09.jpg) no-repeat center center / cover"></canvas>
		<div class="forget_view">
			<el-form :model="forgetForm" class="forget_box">
				<div class="forget_title">基于SpringBoot+Vue的游乐园管理系统{{pageType==1?'找回密码':pageType==2?'输入密保':'重置密码'}}</div>
				<div class="tab_view">
		...
		.forget_box {
			...
			.list_btn {
				...
				:deep(.el-button--success) {
					...
					margin: 0 10px 0 0;
					color: #fff;
					background: linear-gradient(270deg, rgba(127,85,151,1) 0%, rgba(179,100,145,1) 100%),#ad6190;
					width: auto;
					font-size: 14px;
					height: 36px;
				}
