				...
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="父节点id" prop="parentid">
							<el-input class="list_inp" v-model="form.parentid" placeholder="父节点id"
								 type="text" 								:readonly="!isAdd||disabledForm.parentid?true:false" />
						</el-form-item>
					</el-col>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.content = res.data.data.content?(res.data.data.content.replace(reg,'../../../cl1960964/file')):'';
