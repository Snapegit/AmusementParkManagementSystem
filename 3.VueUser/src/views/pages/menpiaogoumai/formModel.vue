	...
	<div class="app-contain" :style='{"padding":"0 18%","margin":"0px auto","alignItems":"flex-start","flexWrap":"wrap","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">购买时间</div>
					<div  class="info_text" >{{detail.goumaishijian}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('menpiaogoumai','支付')" class="approval_btn" @click="payClick">支付</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('menpiaogoumai','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('menpiaogoumai','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
