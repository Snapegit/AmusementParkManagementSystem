	...
	<div class="app-contain" :style='{"width":"100%","padding":"0 18%","margin":"0","overflow":"hidden","background":"#fff"}'>
		...
		<el-form :inline="true" :model="searchQuery" class="list_search">
			...
			<div class="search_btn_view">
				...
				<el-button class="add_btn" type="success" v-if="btnAuth('xiangmufenlei','新增')" @click="addClick">新增</el-button>
			</div>
		</el-form>
...
<script setup>
	...
	const addClick = () => {
		router.push('/index/xiangmufenleiAdd')
	}
	//判断是否从个人中心跳转
	...
	const detailClick = (id) => {
		router.push('xiangmufenleiDetail?id=' + id + (centerType.value?'&&centerType=1':''))
	}
	//下载文件
	const download = (file) =>{
		if(!file){
