		...
		<div class="register_view">
			...
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					...
					<input class="list_inp" v-model="registerForm.yuangongmima2" type="password" placeholder="请输入确认员工密码" />
				</div>
				<div class="list_item">
...
<style lang="scss" scoped>
	.register_view {
		...
		background: url(http://clfile.zggen.cn/20231016/35644becdb81459c99e81cb9cd43e9c6.png);
		display: flex;
		min-height: 100vh;
